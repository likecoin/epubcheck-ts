...
> **Status**: Measured against EPUBCheck 5.4.0 across 763 spec fixtures — **95.9% agreement on whether a publication is valid**, 87.5% agreement on which errors and warnings are reported. See [PROJECT_STATUS.md](_media/PROJECT_STATUS.md) for the full breakdown and methodology. For formal EPUB 3 conformance certification, use the official [Java EPUBCheck](https://github.com/w3c/epubcheck).
